...
// self is a pointer to the instance of the contract, enum or struct.

// It allows access to storage and methods of that specific instance.

// It's a convention that makes code more readable and clear.